// src/screens/PatientSettingsScreen.tsx
...
export default function PatientSettingsScreen({ navigation }: any) {
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.header, { backgroundColor: colors.cardBackground }]}>
          <View style={styles.profileSection}>
            ...
            <Text style={[styles.userName, { color: colors.text }]}>{user?.displayName || patient?.name || 'Danışan'}</Text>
        ...
        {/* Body Stats */}
        {patient && (patient.weight || patient.height) && (
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Vücut Ölçülerim</Text>
              ...
              <View style={styles.statsContainer}>
                {patient.weight && (
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statValue, { color: colors.text }]}>{patient.weight} kg</Text>
                    <Text style={[styles.statLabel, { color: colors.textLight }]}>Güncel Kilo</Text>
                  </View>
                )}
                {patient.height && (
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statValue, { color: colors.text }]}>{patient.height} cm</Text>
                    <Text style={[styles.statLabel, { color: colors.textLight }]}>Boy</Text>
                  </View>
                )}
                {patient.targetWeight && (
                  <View style={styles.statItem}>
                    ...
                    <Text style={[styles.statValue, { color: colors.text }]}>{patient.targetWeight} kg</Text>
                    <Text style={[styles.statLabel, { color: colors.textLight }]}>Hedef Kilo</Text>
                  </View>
                )}
              </View>
            </View>
        ...
        {/* My Progress */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>İlerleme</Text>
          <View style={[styles.settingsCard, { backgroundColor: colors.cardBackground }]}>
            <SettingItem
              icon="trending-up-outline"
              title="İlerleme Takibi"
              subtitle="Kilo değişimlerinizi görüntüleyin"
              onPress={() => navigation.navigate('PatientProgress')}
            />
            <View style={[styles.divider, { backgroundColor: colors.border }]} />
            <SettingItem
              icon="camera-outline"
              title="Öğün Fotoğrafları"
              subtitle="Yemek fotoğraflarınızı paylaşın"
