...
<Stack.Screen
  ...
  options={{ title: 'Yeni Danışan' }}
/>
<Stack.Screen
  name="EditPatient"
  component={AddEditPatientScreen}
  options={{ title: 'Danışan Düzenle' }}
/>
<Stack.Screen
  name="PatientProfile"
...
<Stack.Screen
  name="ViewPatientProgress"
  component={ViewPatientProgressScreen}
  options={{ title: 'Danışan İlerlemesi' }}
/>
<Stack.Screen
...
/>
<Stack.Screen
  name="DietitianPlansList"
  component={DietitianPlansListScreen}
  options={{ title: 'Diyet Planları' }}
/>
<Stack.Screen
  name="DietPlanDetail"
  component={DietPlanDetailScreen}
  options={{ title: 'Plan Detayı' }}
/>
<Stack.Screen
  name="EditDietPlan"
  component={EditDietPlanScreen}
  options={{ title: 'Planı Düzenle' }}
/>
<Stack.Screen
...
/>
<Stack.Screen
  name="DietitianQuestions"
  component={DietitianQuestionsScreen}
  options={{ title: 'Danışan Soruları' }}
/>
<Stack.Screen
  name="AnswerQuestion"
  component={AnswerQuestionScreen}
  options={{ title: 'Soruyu Cevapla' }}
/>
<Stack.Screen
  name="EditProfile"
...
<Stack.Screen
  ...
  options={{ title: 'Yeni Randevu Oluştur' }}
/>
<Stack.Screen
  name="DietitianAppointments"
  component={DietitianAppointmentsScreen}
...
/>
        ...
        />
        <Stack.Screen
  name="DietitianMealPhotos"
  component={DietitianMealPhotosScreen}
  options={{ title: 'Hastanın Öğün Fotoğrafları' }}
/>
        <Stack.Screen
  name="PatientMealPhoto"
  component={PatientMealPhotoScreen}
  options={{ headerTitle: '' }}
/>
        <Stack.Screen
  name="DietitianHome"
